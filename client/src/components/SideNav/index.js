                ...
                <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div className="sb-sidenav-menu">
                        <div className="nav">
                            ...
                            <a className="nav-link collapsed" href="/" data-toggle="collapse" data-target="#collapseLayouts-monitoring" aria-expanded="false" aria-controls="collapseLayouts-planning">
                            <div className="sb-nav-link-icon"><i className="fas fa-columns"></i></div>Monitoring
                                    <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div></a>
